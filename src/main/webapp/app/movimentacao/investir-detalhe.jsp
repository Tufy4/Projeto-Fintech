...
<%
    // Formatação de moeda para exibir o saldo bonito
    Locale localeBR = new Locale("pt", "BR");
    NumberFormat dinheiro = NumberFormat.getCurrencyInstance(localeBR);
    
    // Recupera o saldo da sessão para mostrar ao usuário
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-custom">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/app/movimentacao/investir.jsp" class="btn btn-outline-light btn-sm">
                ...
                <form action="${pageContext.request.contextPath}/app?command=finalizarInvestimento" method="post">
                    ...
                    <div class="mb-4">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="valorInput" name="valor" 
                    ...
                    <input type="hidden" name="numeroConta" value="${sessionScope.conta.numero_conta}">
                    ...
                    <div class="info-rendimento">
                        <i class="bi bi-shield-check me-1"></i> Investimento garantido pelo FGC.<br>
                        Ao confirmar, o valor será debitado da sua conta corrente.
                    </div>
                </form>
            </div>
        </div>
