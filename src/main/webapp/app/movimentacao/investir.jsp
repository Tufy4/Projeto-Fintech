...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark mb-4">
        <div class="container container-custom d-flex justify-content-between align-items-center">
            <a class="navbar-brand fw-bold" href="#">BitPay <span class="badge bg-primary">IB</span></a>
            <a href="${pageContext.request.contextPath}/app/home.jsp" class="btn btn-outline-light btn-sm">Voltar para Home</a>
        </div>
    </nav>
    ...
    <div class="container-custom">
        ...
        <p class="subtitle">Faça seu dinheiro render com segurança e liquidez.</p>

        <div class="action-bar">
            <div>
                <h5 class="m-0 fw-bold text-muted" style="font-size: 1rem;">Já possui aplicações?</h5>
                <small class="text-muted">Acompanhe seus rendimentos agora.</small>
            </div>
            <a href="${pageContext.request.contextPath}/app?command=meusInvestimentos" class="btn-meus-investimentos">
                <i class="bi bi-wallet2"></i> Ver Meus Investimentos
            </a>
        </div>
        ...
        <div class="cards">
            ...
            <a class="card-invest"
               href="${pageContext.request.contextPath}/app?command=escolherInvestimento&produto=CDB_DI">
                ...
                <div class="rent"><i class="bi bi-graph-up-arrow me-1"></i> 100% do CDI</div>
            ...
            <a class="card-invest"
               href="${pageContext.request.contextPath}/app?command=escolherInvestimento&produto=CDB_1ANO">
                ...
                <div class="desc">Rende mais que a poupança, com garantia do FGC.</div>
                <div class="rent"><i class="bi bi-graph-up-arrow me-1"></i> 115% do CDI</div>
                <div class="btn-investir">Investir Agora</div>
            </a>
