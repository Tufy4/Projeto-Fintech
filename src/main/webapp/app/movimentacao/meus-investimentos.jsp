...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			<a class="navbar-brand fw-bold" href="#">BitPay <span
				class="badge bg-primary">IB</span></a>
			<div class="d-flex">
				<a href="${pageContext.request.contextPath}/app/home.jsp"
					class="btn btn-outline-light btn-sm me-2">Voltar</a> <a
	...
	<div class="hero-invest text-center">
		<div class="container">
			...
			<p class="lead opacity-75">Acompanhe a evolução do seu
				patrimônio.</p>

			<div class="total-badge">
				<span class="d-block text-uppercase small opacity-75">Total
					Aplicado (Ativo)</span> <span class="fs-2 fw-bold"><%=dinheiro.format(total)%></span>
			</div>
		</div>
	</div>
		...
		<div class="row g-4">
			...
			<div class="col-12 text-center mt-5">
				<div class="p-5 bg-white rounded shadow-sm">
					...
					<h3 class="mt-3 text-muted">Você ainda não possui
						investimentos.</h3>
					<a
						href="${pageContext.request.contextPath}/app/movimentacao/investir.jsp"
						class="btn btn-primary mt-3 px-4 rounded-pill"> Começar a
						Investir </a>
				</div>
			</div>
			<%
			...
			<div class="col-md-6 col-lg-4">
				<div class="invest-card">
					<div class="card-header-custom">
						...
						<span class="status-badge <%=statusClass%>"> <%=inv.getStatus()%>
						</span>
					</div>
					...
					<div class="card-body">
						...
						<div class="detail-row">
							<span><i class="bi bi-calendar-event me-2"></i>Aplicado
								em:</span> <span class="fw-medium"><%=dataFmt.format(inv.getDataInicio())%></span>
						</div>

						<div class="detail-row">
							<span><i class="bi bi-calendar-check me-2"></i>Vencimento:</span>
							<span class="fw-medium"> <%=(inv.getDataFim() != null) ? dataFmt.format(inv.getDataFim()) : "Liquidez Diária"%>
							</span>
						</div>
						...
						<div class="d-grid">
							<button class="btn btn-outline-primary btn-sm rounded-pill"
								disabled>Processando Rendimentos...</button>
						</div>
						<%
						}
						%>
	...
	<a
		href="${pageContext.request.contextPath}/app/movimentacao/investir.jsp"
		class="btn btn-primary btn-fab" title="Novo Investimento"> <i
