...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/app/home.jsp" class="btn btn-outline-light btn-sm">
    ...
    <div class="container main-content">
        <div class="card-transfer">
            ...
            <div class="card-body p-4">
                ...
                <form action="${pageContext.request.contextPath}/app?command=transferir" method="post">
                    
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="contaDestino" name="contaDestino" required placeholder="00000">
                        <label for="contaDestino">Número da Conta Destino</label>
                    </div>
