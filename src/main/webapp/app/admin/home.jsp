...
<body>
	...
	<section id="operacoes" class="container py-5">
            ...
            <div class="col">
                <a href="${pageContext.request.contextPath}/app?command=consultarBloqueados" class="text-decoration-none text-dark">
                   <div class="feature-col text-center p-4 border rounded shadow-sm h-100 bg-white">

                        <div class="feature-icon">📄</div>

                        <h3 class="fs-4">Liberação</h3>
                        <p class="small text-muted">Consultando usuarios que necessitam de liberação</p>
                    </div>
                </a>
            </div>
