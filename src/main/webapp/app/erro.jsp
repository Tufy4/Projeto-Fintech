...
<title>BitPay | ${not empty titulo ? titulo : 'Erro'}</title>
			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav gap-2 align-items-center">
					...
					<li class="nav-item"><span class="nav-link text-white">
							<strong>${sessionScope.usuarioLogado != null ? sessionScope.usuarioLogado.getNome() : 'Visitante'}</strong>
					</span></li>
		...
		<div class="col-12 col-sm-10 col-md-8 col-lg-6">
			<div class="card shadow border-0">
				<div class="card-body text-center p-4 p-md-5">
					...
					<h4 class="card-title fw-bold mb-3 text-danger">${not empty titulo ? titulo : 'Ocorreu um erro inesperado'}
					</h4>

					<div class="alert alert-light border-danger text-danger mb-4"
						role="alert">
						<i class="bi bi-exclamation-triangle-fill me-2"></i> ${not empty erro ? erro : 'Não foi possível completar a operação.'}
					</div>

					<a
						href="${not empty linkDestino ? linkDestino : pageContext.request.contextPath + '/app?command=dashboardCliente'}"
						class="btn btn-danger btn-lg w-100"> ${not empty textoBotao ? textoBotao : 'Voltar ao Início'}
					</a>
