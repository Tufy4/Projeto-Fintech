...
<body>
	...
	<form action="${pageContext.request.contextPath}/app?command=login" method="post">
		<label>Usuário: </label> <input type="email" name="user" required>
	...
	<h2>Não tem conta?</h2>
	<a href="${pageContext.request.contextPath}/app?command=redirect&url=auth/cadastro.jsp">Clique aqui para se cadastrar!</a>
</body>
</html>