    ...
    <div class="auth-card">
        ...
        <form action="${pageContext.request.contextPath}/app?command=login" method="post">
            <div class="form-floating mb-3">
                <input type="email" class="form-control" id="email" name="user" placeholder="nome@exemplo.com" required>
        ...
        <div class="text-center mt-4">
            <p class="text-muted small">Ainda não tem conta? 
                <a href="${pageContext.request.contextPath}/app?command=redirect&url=auth/cadastro.jsp" class="text-decoration-none fw-bold">Cadastre-se</a>
            </p>
        </div>
    </div>
