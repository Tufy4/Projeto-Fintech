...
<body>
		...
		<div class="container">
			...
			<div class="d-flex justify-content-center gap-3">
				<a
					...
					class="btn btn-primary btn-lg px-5 rounded-pill fw-bold">Começar
					Agora</a> <a
					href="${pageContext.request.contextPath}/app?command=redirect&url=auth/login.jsp"
					class="btn btn-outline-light btn-lg px-5 rounded-pill">Já sou
					cliente</a>
			</div>
		</div>
	</header>
		...
		<div class="row g-4 row-cols-1 row-cols-lg-3">
			...
			<div class="col">
				<div class="feature-card text-center">
					...
					<p class="text-secondary">Seus dados e transações protegidos
						com as melhores práticas de criptografia ponta a ponta.</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="feature-card text-center">
					...
					<p class="text-secondary">Diversifique sua carteira com opções
						de renda fixa e variável. Rentabilidade em tempo real.</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="feature-card text-center">
					...
					<p class="text-secondary">Simule e contrate empréstimos com
						transparência. Sistema SAC integrado e taxas justas.</p>
				</div>
			</div>
	...
	<footer class="bg-dark text-white text-center py-4">
		<p class="mb-0 opacity-50">&copy; 2025 BitPay Fintech. Todos os
