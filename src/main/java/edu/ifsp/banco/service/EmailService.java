...
public class EmailService {
    ...
    private static final String MEU_EMAIL = "colocar gmail"; 
    private static final String MINHA_SENHA_APP = "xxxx xxxx xxxx xxxx"; // senha de apps gerada na config de conta
