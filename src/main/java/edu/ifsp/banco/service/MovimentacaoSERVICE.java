...
import edu.ifsp.banco.modelo.Movimentacoes.tipoStatus;
...
public class MovimentacaoSERVICE {
    ...
    public void registrarMovimentacao(Movimentacoes mov, int idContaOrigem, int idContaDestino, BigDecimal valor) throws Exception {
        ...
        try {
            ...
            mov.setStatus(tipoStatus.CONCLUIDA.getValor());
    ...
    public void alterarStatusMovimentacao(int idMov, tipoStatus novoStatus) throws Exception {
