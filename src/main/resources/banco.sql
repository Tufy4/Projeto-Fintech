...
CREATE TABLE MOVIMENTACOES (
    ...
    DATA_TRANSACAO TIMESTAMP DEFAULT CURRENT_TIMESTAMP, //MELHORAR REPRESENTAÇÃO DO BANCO COM BASE NA TRANSAÇÃO, ACRESCENTANDO DATA DE INICIO E FIM DO PROCESSO
...
CREATE TABLE EXTRATOS (
    ...
    CONSTRAINT FK_EXTRATOS_CONTA FOREIGN KEY (CONTA_ID) REFERENCES CONTAS(ID)
);
